...
import { Users, UserPlus, ArrowLeft, BarChart2, X } from 'lucide-react'
import TopBar from '../../components/layout/TopBar'
import GroupFeedCard from '../components/GroupFeedCard'
import { getGroup, getGroupFeed, getGroupScore, addMember, removeMember } from '../api/groups'
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-10">
        ...
        <div className="flex items-end gap-6 mb-6">
          ...
          <div>
            <p className="text-[#B3B3B3] text-xs font-bold uppercase tracking-widest mb-1">Group</p>
            <h1 className="text-white font-black text-3xl mb-1">{group.name}</h1>
        ...
        <div className="flex gap-1 mb-5 bg-[#1a1a1a] rounded-full p-1 w-fit">
          {['feed', 'members'].map(t => (
            <button
              key={t}
              onClick={() => setTab(t)}
              className={`px-5 py-1.5 rounded-full text-sm font-semibold transition-colors capitalize ${
