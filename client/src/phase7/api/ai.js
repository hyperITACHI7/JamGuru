...
export const suggestForRequest        = (requestId) => api.post('/ai/suggest-for-request', { requestId })
export const suggestForGroupRequest   = (requestId) => api.post('/ai/suggest-for-group-request', { requestId })
